...
-- Obtenido de https://github.com/acmeism/RosettaCodeData/blob/master/Task/Bitmap-Midpoint-circle-algorithm/Haskell/bitmap-midpoint-circle-algorithm-1.hs#L14
